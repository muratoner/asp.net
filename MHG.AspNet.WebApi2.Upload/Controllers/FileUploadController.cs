...
using MHG.AspNet.WebApi2.Upload.Attributes;
using MHG.AspNet.WebApi2.Upload.Models;

namespace MHG.AspNet.WebApi2.Upload.Controllers
{
    ...
    public class FileUploadController : ApiController
    {
        ...
        public async Task<FileResult> UploadSingleFile()
        {
            ...
            {
                FileNames =
                    streamProvider.Contents.AsEnumerable().Select(T => T.Headers.ContentDisposition.FileName).ToArray(),
                Names =
                    streamProvider.Contents.AsEnumerable().Select(T => T.Headers.ContentDisposition.FileName).ToArray(),
                ContentTypes =
                    streamProvider.Contents.AsEnumerable()
                        .Where(T => T.Headers.ContentType != null)
                        .Select(T => T.Headers.ContentType.MediaType)
                        .ToArray(),
